...
def get_earnings_increment(daily_profit_from, daily_profit_to):
    """
    حساب زيادة الأرباح لكل 10 ثواني باستخدام min و max مع عامل عشوائي
    والدقة الافتراضية لـ Decimal
    """
    # ربح كل 10 ثواني من الحدين
    min_profit = Decimal(daily_profit_from) / Decimal('17280')
    max_profit = Decimal(daily_profit_to) / Decimal('17280')
